...
const Start = ({setIsFirstScreen}:myProps) => {
  return (
    ...
    <h2 className="text-xl text-black ">Healthy foods help us stay fit!  Unhealthy foods can be eaten sometimes but not regularly! Drag and Drop healthy items for breakfast, lunch, and dinner for a day. Your budget is 50 BUCKS!</h2>
    </div>
