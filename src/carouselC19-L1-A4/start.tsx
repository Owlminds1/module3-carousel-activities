...
const Start = ({setIsFirstScreen}:myProps) => {
  return (
    ...
    <h2 className="text-2xl text-black ">Drag the emotion labels in correct category    </h2>
    </div>
  <StartBtn value='Start' setIsFirstScreen={setIsFirstScreen} screenVal="EmotionSlide" />
  </div>
  )
}
