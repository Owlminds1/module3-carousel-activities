          ...
          >
            <SwiperSlide>
              <div className="min-h-[400px] p-5 flex justify-center items-center">
                <h5 className="text-[35px] text-center text-black">
                  You’ve to prepare for a poem recitation. But you are too shy
                  to speak in front of people. And you’re fearful of forgetting
                  the poem.{" "}
                </h5>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className="min-h-[300px] p-5 flex justify-center items-center flex-col gap-5">
                ...
                <h5 className="text-3xl text-center text-black">
                  Say out loud what you’d say in the mirror
                </h5>
                <ul className="list-disc">
                  ...
                  <li className="text-black text-2xl ">
                    I will be happy after the recitation
                  </li>
                  <li className="text-black text-2xl ">
                    I will practice until I’m confident
                  </li>
                  <li className="text-black text-2xl ">
            ...
            <SwiperSlide>
              <div className="min-h-[300px] p-5 flex justify-center items-center flex-col gap-5">
                <h5 className="text-3xl font-bold text-center text-black">
                  Say out loud what you’d say to others if you fail
                </h5>
                <ul className="list-disc w-[500px] space-y-3">
                  <li className="text-black text-2xl ">
                    I understand that I failed, but I’d appreciate it if you can
                    be kind.
                  </li>
                  <li className="text-black text-2xl ">
                    I see your point of view, but I do not like how you speak to
                    me.
                  </li>
                  <li className="text-black text-2xl ">
                    I see, but I don’t agree that people who fail are losers
                  </li>
                  <li className="text-black text-2xl ">
                    I feel that you’re being very mean. I would appreciate some
                    distance.
                  </li>
                  <li className="text-black text-2xl ">
                    If you don’t stop, I will have to tell the teacher.
                  </li>
                </ul>
              </div>
            </SwiperSlide>
