...
const Start = ({setIsFirstScreen}:myProps) => {
  return (
    ...
    <h2 className="text-2xl text-black ">Select the correct answer by clicking on the option</h2>
    </div>
  <StartBtn value='Start' setIsFirstScreen={setIsFirstScreen} screenVal="QustionSlide" />
  </div>
  )
}
