...
import SlideData from "@/carouselC22-L2-A1/slideData.json";
  ...
  return (
    <div className="min-h-screen bg-[#F8FCFA] p-5 flex justify-center items-center flex-col gap-5">
      <div className="w-[800px]">
        ...
        <iframe width="710" height="315" src="https://www.youtube.com/embed/WIPV1iwzrzg?si=fkzz_YyS3SIARUQs" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>  
        </div>
