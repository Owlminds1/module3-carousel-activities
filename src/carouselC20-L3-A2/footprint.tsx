            ...
            <SwiperSlide>
              <div className="grid grid-cols-12 place-items-center gap-2 w-full h-full">
                <div className="col-span-6 border border-black  w-full rounded-lg min-h-[400px]  flex gap-10 justify-center items-center flex-col ">
                  ...
                  <button  onClick={handleAdd } className="text-white cursor-pointer bg-violet-900 px-8 py-2 rounded-lg">
                    Submit
                  </button>
                </div>
                ...
                >
                     <h4 className="text-xl font-bold text-black text-center ">Here is one list for your reference</h4>
                  <ul className={`  space-y-5 list-disc p-5 `}>
                    ...
                    <li className="text-xl">Purchase energy-efficient appliances                    </li>
                    ...
                    <li className="text-xl">Donate used items in good condition</li>
                    <li className="text-xl">Go paperless with bills, newsletters, magazines</li>
                    <li className="text-xl">Carry a refillable water bottle and bring your own mug to coffee shops
                    </li>
                  </ul>
                </div>:"" }
