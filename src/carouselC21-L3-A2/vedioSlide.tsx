...
const VedioSlide = ({setIsFirstScreen}:myProps) => {
  return (
    <div className='min-h-screen flex justify-center items-center flex-col gap-5 bg-[#F8FCFA]'>
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/ZmNpeXTj2c4?si=1QlrcTfmVmyhjwLJ" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
      <div
