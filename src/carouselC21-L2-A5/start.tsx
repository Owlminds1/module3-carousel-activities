...
const Start = ({setIsFirstScreen}:myProps) => {
  return (
    ...
    <h2 className="text-2xl text-black ">{`Let’s mark the pauses in each sentence by adding a ‘/’`}</h2>
    </div>
  <StartBtn value='Start' setIsFirstScreen={setIsFirstScreen} screenVal="NextSlide" />
  </div>
  )
}
