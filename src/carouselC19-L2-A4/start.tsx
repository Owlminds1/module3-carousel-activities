...
const Start = ({setIsFirstScreen}:myProps) => {
  return (
    ...
    <h2 className="text-2xl text-black ">Think of all those acts of kindness that made you want to pay it forward! Revise your reactions.</h2>
    </div>
  <StartBtn value='Start' setIsFirstScreen={setIsFirstScreen} screenVal="slideScreen" />
  </div>
  )
}
