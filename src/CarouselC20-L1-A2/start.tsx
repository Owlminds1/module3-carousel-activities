...
const Start = ({setIsFirstScreen}:myProps) => {
  return (
    ...
    <h2 className="text-2xl text-black ">Select items from the master list to create trash free lunch bag</h2>
    </div>
  <StartBtn value='Start' setIsFirstScreen={setIsFirstScreen} screenVal="SchoolBeg" />
  </div>
  )
}
